...
#ifndef COSIM_FMI_FMI1_FMU_HPP
#define COSIM_FMI_FMI1_FMU_HPP
...
public:
    fmi1_fmu(std::unique_ptr<fmicontext> ctx, std::shared_ptr<cosim::temp_dir> tmpDir, bool fmiLogging = true);
