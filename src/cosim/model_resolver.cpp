...
#include "cosim/fmi/fmi_model_sub_resolver.hpp"
#include "cosim/fmi/proxy/proxy_model_sub_resolver.hpp"
#include "cosim/logger/logger.hpp"

using namespace cosim;

std::unique_ptr<model_resolver> cosim::default_model_resolver()
{
